...
* [ ] select Reports from the side menu, review, print, or save a _`Full Election Tally Report`_ for the results&#x20;
...
* [ ] select Reports from the side menu, print and save an official _`Full Election Tally Report`_ as a .pdf and .csv for the results&#x20;
